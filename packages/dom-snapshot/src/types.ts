...
export interface CollectorOptions {
  ...
  /**
   * Maximum DOM nesting depth to descend. Guards against stack-overflow on
   * pathologically deep (or maliciously crafted) DOMs. Defaults to 1000 — far
   * beyond any real page, so normal collection is unaffected.
   */
  maxDepth: number;
}
