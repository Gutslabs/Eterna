...
/** String-in, string-out variant for dangerouslySetInnerHTML call sites. */
export function sanitizeSvgOuterHtml(markup: string): string | null {
  return sanitizeSvgMarkup(markup)?.outerHTML ?? null;
}
